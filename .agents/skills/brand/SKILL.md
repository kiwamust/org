...
name: brand
description: >-
  Brand局。kiwamu.sato のブランド構築と発信。記事・スライド・Vlog の企画から完成まで。
  Anti-Convergence を死守し、文体の一貫性を担保する。
  「記事を書いて」「スライド」「Vlog」「コンテンツ」「発信」「ブランド」等で発動。
---
...
- **文体遵守**: kiwamu.sato の文体ガイドに準拠。短文の連打、アナロジー、テーゼ先出し、造語、体験に紐づけた語り。文体参照: `~/.Codex/AGENTS.md` の文体セクション、`~/Desktop/work/work/kiwamu.satoの文体.md`
